 ...
 * 
 */  
this.ckan.module('image_upload_extended', function($, _) {
  return {
    ...
    initialize: function () {
      ...
      this.button_url = $('<a href="javascript:;" class="btn"><i class="icon-globe"></i> '+this.i18n('url')+'</a><a href="javascript:;" class="btn"><i class="icon-cloud"></i> Web Service</a><a href="javascript:;" class="btn"><i class="icon-road"></i> MDM</a>')
